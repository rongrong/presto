        ...
        implements SessionSupplier
{
            ...
            SessionContext context)
    {
        ...
        for (Map.Entry<String, Map<String, String>> catalogProperties : context.getCatalogSessionProperties().entrySet()) {
        ...
        for (Map.Entry<String, String> preparedStatement : context.getPreparedStatements().entrySet()) {
