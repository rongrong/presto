...
public class SemanticTypeProvider
{
    ...
    {
        return new SemanticTypeProvider(ImmutableMap.copyOf(types.entrySet().stream().collect(toImmutableMap(Map.Entry::getKey, entry -> new TypeWithName(entry.getValue())))));
    }
