        ...
        extends ExpressionRewriteRuleSet
{
    ...
    public static class InlineSqlFunctionsRewriter
    {
        ...
        public static Expression rewrite(Expression expression, Session session, Metadata metadata, PlanVariableAllocator variableAllocator, Map<NodeRef<Expression>, TypeWithName> expressionTypes)
        {
                ...
                extends com.facebook.presto.sql.tree.ExpressionRewriter<Void>
        {
            ...
            public Visitor(Session session, Metadata metadata, PlanVariableAllocator variableAllocator, Map<NodeRef<Expression>, TypeWithName> expressionTypes)
            {
            ...
            {
                List<TypeWithName> argumentTypes = new ArrayList<>();
